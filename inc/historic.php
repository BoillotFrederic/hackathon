  ...
  <div class="modal-content">
    ...
    <img src="imgs/winner.jpg" class="win responsive-img center-block">
      <ul class="collection with-header">
        ...
        <li class="blue liste row valign-warpper collection-item"><div class="col m12 s12 l12"><div class="col m4 s6 l4 name"><?php echo $HistoricData['pseudo']; ?></div><div class="col m4 s6 l4" ><?php echo $HistoricData['adddate']; ?></div>
        ...
        <li class="liste row valign-warpper collection-item"><div class="col m12 s12 l12"><div class="col m4 s6 l4 name"><?php echo $HistoricData1['pseudo']; ?></div><div class="col m4 s6 l4"><?php echo $HistoricData1['adddate']; ?></div>
        ...
        <li class="red liste row valign-warpper collection-item"><div class="col m12 s12 l12"><div class="col m4 s6 l4 name"><?php echo $HistoricData2['pseudo']; ?></div><div class="col m4 s6 l4"><?php echo $HistoricData2['adddate']; ?></div>
        ...
        <li class="liste row valign-warpper collection-item"><div class="col m12 s12 l12"><div class="col m4 s6 l4 name "><?php echo $HistoricData3['pseudo']; ?></div><div class="col m4 s6 l4"><?php echo $HistoricData3['adddate']; ?></div>
        ...
        <li class="green liste valign-warpper row collection-item"><div class="col m12 s12 l12"><div class="col m4 s6 l4 name"><?php echo $HistoricData4['pseudo']; ?></div><div class="col m4 s6 l4"><?php echo $HistoricData4['adddate']; ?></div>
        ...
        <li class="liste row valign-warpper collection-item"><div class="col m12 s12 l12"><div class="col m4 s6 l4 name"><?php echo $HistoricData5['pseudo']; ?></div><div class="col m4 s6 l4"><?php echo $HistoricData5['adddate']; ?></div>
        ...
        <li class="yellow liste row valigne-warpper collection-item"><div class="col m12 s12 l12"><div class="col m4 s6 l4 name"><?php echo $HistoricData6['pseudo']; ?></div><div class="col m4 s6 l4"><?php echo $HistoricData6['adddate']; ?></div>
        ...
        <li class="liste row valigne-warpper collection-item"><div class="col m12 s12 l12"><div class="col m4 s6 l4 name"><?php echo $HistoricData7['pseudo']; ?></div><div class="col m4 s6 l4"><?php echo $HistoricData7['adddate']; ?></div>
